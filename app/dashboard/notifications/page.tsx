    ...
    <div className="flex min-h-screen bg-background lg:pl-64">
      ...
      <main className="flex-1 overflow-auto w-full">
        <div className="p-4 sm:p-6 lg:p-8 mt-16 lg:mt-0">
          ...
          <p className="text-muted-foreground mb-8">Send notifications to tourist mobile app</p>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              ...
              <CardDescription>Broadcast to all app users</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  placeholder="Parking Area A now at 90% capacity"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  placeholder="Please consider alternate parking areas..."
                  className="w-full px-3 py-2 border border-border rounded-lg text-foreground bg-background min-h-20"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <select className="w-full px-3 py-2 border border-border rounded-lg text-foreground bg-background">
                  <option>High - Urgent alerts</option>
                  <option>Normal - General updates</option>
                  <option>Low - Information</option>
                </select>
              </div>
          ...
          <Card className="bg-card border-border mt-6">
            <CardHeader>
              ...
              <CardDescription>Last 5 broadcasts sent</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                {[
                  { title: 'Occupancy Alert', message: 'Botanical Garden at 85% capacity', time: '2 hours ago', status: 'Delivered' },
                  { title: 'Weather Update', message: 'Expected rainfall in evening', time: '5 hours ago', status: 'Delivered' },
                  { title: 'Special Event', message: 'Summer festival this weekend', time: '1 day ago', status: 'Delivered' },
                ].map((notif, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                    ...
                    <div className="text-right">
                      <Badge className="bg-green-100 text-green-800">{notif.status}</Badge>
